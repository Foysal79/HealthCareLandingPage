...
const Services = () => {
    return (
        <div className='w-10/12 mx-auto mt-52 bg-[#ffffef] rounded-[32px] py-10 pl-10 space-y-16' >
            {/* session - 1 */}
            <div className='grid grid-cols-2 w-11/12 mx-auto'>
                
                <div className='space-y-6' >
                    <button className=' cursor-pointer py-2 px-6 border-[1.5px] border-black rounded-3xl text-sm' >Service</button>
                ...
                <div className='w-[524px] relative' >
                    ...
                    <div className='bg-[#343268] rounded-[32px] p-6 space-y-4  w-9/12  absolute  opacity-85 bottom-10 left-8' >
                        ...
                        <CgArrowTopRight className='font-extrabold md:text-5xl bg-[#FFC637] text-white rounded-full ' />
                        </div>
                    </div>
                </div>
            </div>
